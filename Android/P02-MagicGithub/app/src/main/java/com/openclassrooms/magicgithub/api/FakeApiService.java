...
public class FakeApiService implements ApiService {
    ...
    public void generateRandomUser() {
        ...
        int randomUserIndex = random.nextInt(FakeApiServiceGenerator.FAKE_USERS_RANDOM.size());
        users.add(FakeApiServiceGenerator.FAKE_USERS_RANDOM.get(randomUserIndex));
    }
